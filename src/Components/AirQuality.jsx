...
const urlLocation =
  // `https://api.openweathermap.org/geo/1.0/zip?zip=301019,IN&appid=${import.meta.env.REACT_APP_API_KEY}`;
    `https://api.openweathermap.org/geo/1.0/zip?zip=301019,IN&appid=0223c39a61c5120938eb1733b306d0b1`;
...
const AirQuality = () => {
    ...
    return (
        ...
        <div className="container">
            ...
            <button className="btn" onClick={() => navigate('/plantrecom')}>Recommendation</button>
        </div>
        </>
    );
};
